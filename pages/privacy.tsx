      ...
      <article className="mx-auto max-w-2xl space-y-12 px-6 py-24 dark:bg-gray-800 dark:text-gray-50">
        ...
        <div className="dark:text-gray-100">
          ...
          <p className="mb-4">
            ...
            any orders placed through our website (including processing your
          ...
          <p className="mb-4">
            ...
            generally to improve and optimize our website.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            have with you (for example if you make an order through our
